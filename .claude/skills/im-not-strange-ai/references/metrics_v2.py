"""im-not-strange-ai v2.0 quantitative metrics calculator.
...
_V1_METRICS_DIR = os.path.join(
    _PROJECT_ROOT, ".claude", "skills", "im-not-strange-ai", "references"
)
...
def _main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="im-not-strange-ai v2.0 metric runner")
