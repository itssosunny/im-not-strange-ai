...
- 기존 monolith 정의(`agents/im-not-strange-ai-monolith.md`, 무수정 검증 대상)
...
검증 절차:
1. agents/im-not-strange-ai-monolith.md diff 확인 (변경 0건 확인)
...
## v1.6 → v2.0 호환성
- 슬래시 커맨드 /im-not-strange-ai-fast·/im-not-strange-ai-redo 그대로
...
### Unchanged (4대 철칙)
- agents/im-not-strange-ai-monolith.md (무수정)
...
## 작업 원칙
1. **monolith 무수정 검증** — agents/im-not-strange-ai-monolith.md grep, 변경 0건. 변경 발견 시 즉시 alert.
...
- Bash(im-not-strange-ai-monolith.md diff 확인 ≤ 2회, monolith 도구 카운트 grep ≤ 2회)

총 도구 호출 ≤ 14회.

## 자체 검증
- quick-rules_v2.md 줄 수 ≤ 180
- agents/im-not-strange-ai-monolith.md diff = 0
- PR 초안에 회귀 결과 표 포함
